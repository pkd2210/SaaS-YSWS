...
<div class="center">
    ...
    <p class="subtitle" style="text-align: center">You Ship: Something that connect to an existing application (n8n node, minecraft mod, Discord / slack bot, more....)<br>We Ship: Everything the comes with a cable (Cables, mouses, keyboards, more...)</p>
